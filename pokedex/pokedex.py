class Pokemon:
    ...
    def __init__(self,num,nom,niv,pv,att,défense,type,évol):
        self.num = num
        self.nom = nom
        self.pv = pv
        self.niv = niv
...
class Pokedex:
    ...
    def choix(self):
        ...
        if choix_utilisateur == '1':
            pokemon_choisi = Pokemon(4, "Salamèche", 1, 39, 52, 43, "Feu", 1)
        elif choix_utilisateur == '2':
            pokemon_choisi = Pokemon(1, "Bulbizarre", 1, 45, 49, 49, "Plante", 1)
        elif choix_utilisateur == '3':
            pokemon_choisi = Pokemon(7, "Carapuce", 1, 44, 48, 65, "Eau", 1)
        else:
            print("Choix invalide. Veuillez choisir un numéro de 1 à 3.")
            pokedex.choix()

        print("Vous avez choisi",pokemon_choisi.nom)
        self.pokemon_choisis.append(self.équipe_pokemon)
...
liste_151_pokemons = [
    ...
    Pokemon(29,"Nidoran",1,55,47,52,"Poison",1),
...
#pokedex.ajouter_plusieurs_pokemons(liste_151_pokemons)
#pokedex.afficher_pokedex()
pokedex.choix()
pokedex.afficher_équipe()